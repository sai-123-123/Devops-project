...
// import { supabase } from "../lib/supabaseClient"; // ❌ Supabase disabled
...
export default function CheckoutPage() {
  ...
  /* ================= APPLY COUPON (DISABLED DB) ================= */
  const applyCoupon = async () => {
    setCouponMsg("Coupon system temporarily disabled");
  };
